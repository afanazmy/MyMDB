...
<html>
	...
	<div id="page">
		...
		<div class="gtco-section gtco-products">
			...
			<div class="gtco-container">
				<?php for ($i=0; $i < $countComingsoon; $i++) { ?>
				<div class="row row-pb-sm">
					<div class="col-md-8 col-md-offset-2 gtco-heading text-center">
						<h2><?php echo $comingsoonweek[$i]->date; ?></h2>
					</div>
				</div>
				<div class="row row-pb-md">
					<?php foreach ($comingsoonweek[$i]->movie as $key => $movie) {?>
					<div class="col-md-4 col-sm-4">
						<a href="#" class="gtco-item one-row bg-img animate-box" style="background-image: url(<?php $movie->urlPoster; ?>)">
							<div class="overlay">
								<i class="ti-arrow-top-right"></i>
								<div class="copy">
									<h3><?php echo $movie -> title; ?></h3>
									<p><?php echo $movie -> simplePlot; ?></p>
								</div>
							</div>
							<img src="<?php $movie->urlPoster; ?>" class="hidden" alt="Free HTML5 Website Template by GetTemplates.co">
						</a>
					</div>
				<?php } ?>
				</div>
